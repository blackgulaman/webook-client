          ...
          <Grid container spacing={5}>
            ...
            <Grid item xs={12} sm={12}>
              <Field
                ...
                name="location"
                label="Location"
                placeholder="Where is the location of your business?"
                fullWidth
                showloading="false"
                InputProps={{
                  startAdornment: (
            ...
            <Grid item xs={12} sm={12}>
              <Field
                ...
                name="businessType"
                label="Business Type"
                placeholder="Select what kind of type is your business"
                fullWidth
                InputProps={{
                  startAdornment: (
                    <InputAdornment position="start">
            ...
            <Grid item xs={12} sm={12}>
              <Field
                ...
                name="category"
                label="Category"
                placeholder="Select categories for your business?"
                fullWidth
                InputProps={{
                  startAdornment: (
                    <InputAdornment position="start">
